...
import { InvokeResult } from '@cerberus/suite-desktop-api';
 ...
 * Default (codesigned builds): @cerberus/suite-desktop,
 * Dev (non-production builds): @cerberus/suite-desktop-dev
 * Local development: @cerberus/suite-desktop-local
 */
