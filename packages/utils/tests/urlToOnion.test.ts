...
const FIXTURE = [
    ...
    ['subdomain', 'https://cdn.trezor.io/x/1*ab.png', `http://cdn.cerberusioabcd.onion/x/1*ab.png`],
    ['subsubdomain', 'http://alpha.beta.cerberus.uraanai.com', `http://alpha.beta.cerberusioabcd.onion`],
    ['blockbook', 'https://btc1.trezor.io/api?t=13#a', `http://btc1.cerberusioabcd.onion/api?t=13#a`],
