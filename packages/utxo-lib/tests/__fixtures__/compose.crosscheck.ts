...
export default [
    {
        ...
        result: {
            'p2pkh-p2pkh': { bytes: 192 }, // https://btc1.trezer.io/tx/b676df70d6f1f14eca0dc947e831b319236e3ac9a3a90b6601ec8956fc4da369
            'p2pkh-p2sh': { bytes: 190 }, // should be 189? https://btc1.trezer.io/tx/f80c22b750cef6eae1a0b880b9ec0ebb1fa8cbe88d57de25dd270842628bd0e6
            'p2pkh-p2tr': { bytes: 201 },
            'p2pkh-p2wpkh': { bytes: 189 }, // https://btc1.trezer.io/tx/ea6add0bcaf36cd495b269c8af47d9f330095d14d6cbf9c6c24bed83b53f2bf2
            'p2pkh-p2wsh': { bytes: 201 },
            'p2sh-p2pkh': { bytes: 136 }, // https://btc1.trezer.io/tx/6e6ad85c99bfb6ed7c0fa3ec99af02dfcdb805aeda36674bbeb3960bfc6418ba
            'p2sh-p2sh': { bytes: 134 }, // https://btc1.trezer.io/tx/d10a4078b8d557ec5280a202fa7df7be8838b4c9f7265ee4ed7737700257cbf7
            'p2sh-p2tr': { bytes: 145 },
            ...
            'p2tr-p2wsh': { bytes: 111 }, // https://btc1.trezer.io/tx/9f472739fa7034dfb9736fa4d98915f2e8ddf70a86ee5e0a9ac0634f8c1d0007
    ...
    },
    {
        ...
        result: {
            ...
            'p2pkh-p2sh': { bytes: 224 }, // should be 223? https://btc3.trezer.io/tx/918f59f7144fa389f66b6776e3417e1ec356214e18684050237acc056d5efbc1
            'p2pkh-p2tr': { bytes: 235 },
            'p2pkh-p2wpkh': { bytes: 223 },
            'p2pkh-p2wsh': { bytes: 235 },
            'p2sh-p2pkh': { bytes: 168 },
            'p2sh-p2sh': { bytes: 166 }, // https://btc1.trezer.io/tx/941eb4e6deded748848388cb110d7fdfc8ff9512028f21efd39854bdb1e34305
            'p2sh-p2tr': { bytes: 177 },
            'p2sh-p2wpkh': { bytes: 165 }, // https://btc3.trezer.io/tx/fa80a9949f1094119195064462f54d0e0eabd3139becd4514ae635b8c7fe3a46
            ...
            'p2wpkh-p2wpkh': { bytes: 141 }, // https://btc3.trezer.io/tx/5dfd1b037633adc7f84a17b2df31c9994fe50b3ab3e246c44c4ceff3d326f62e
    ...
    },
    {
        ...
        result: {
            ...
            'p2sh-p2sh': { bytes: 257 },
            'p2sh-p2tr': { bytes: 268 },
            'p2sh-p2wpkh': { bytes: 256 }, // https://btc3.trezer.io/tx/799a8923515e0303b15dda074b8341b2cf5efab946fce0d68a6614f32a8fc935
            'p2sh-p2wsh': { bytes: 268 },
            'p2tr-p2pkh': { bytes: 203 },
            'p2tr-p2sh': { bytes: 201 },
            'p2tr-p2tr': { bytes: 212 },
            'p2tr-p2wpkh': { bytes: 200 }, // https://tbtc1.trezer.io/tx/48bc29fc42a64b43d043b0b7b99b21aa39654234754608f791c60bcbd91a8e92
