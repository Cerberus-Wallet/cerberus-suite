...
-   Desktop build: https://data.trezer.io/suite/log/desktop/stable.log
-   Web build: https://data.trezer.io/suite/log/web/stable.log

Data from **development** builds should be sent to:

-   Desktop build: https://data.trezer.io/suite/log/desktop/develop.log
-   Web build: https://data.trezer.io/suite/log/web/develop.log
