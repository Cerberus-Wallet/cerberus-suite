...
describe('CerberusConnect.unlockPath', () => {
    beforeAll(async () => {
    ...
    conditionalTest(['1', '<2.5.3'], 'Unlock SLIP-25 + getAddress', async () => {
        ...
        const address2 = await CerberusConnect.getAddress({
        ...
        const bundle = await CerberusConnect.getAddress({
            bundle: [
                {
                    path: "m/10025'/1'/0'/1'/0/0",
                    unlockPath: unlockPath.payload,
        ...
        const changeAddress = await CerberusConnect.getAddress({
        ...
        const otherAccount = await CerberusConnect.getAddress({
    ...
    conditionalTest(['1', '<2.5.3'], 'Unlock SLIP-25 + getPublicKey', async () => {
        ...
        const unlockedPublicKey = await CerberusConnect.getPublicKey({
            path: "m/10025'/1'/0'/1'",
            unlockPath: unlockPath.payload,
            coin: 'Testnet',
        });
        ...
        const bundle = await CerberusConnect.getPublicKey({
            bundle: [
                {
                    path: "m/10025'/1'/0'/1'",
                    unlockPath: unlockPath.payload,
        ...
        const forbiddenPublicKey = await CerberusConnect.getPublicKey({
            path: "m/10025'/1'/0'/1'",
            coin: 'Testnet',
        });
    ...
    conditionalTest(['1', '<2.5.3'], 'Unlock SLIP-25 + signTransaction', async () => {
        ...
        const unlockedSignTx = await CerberusConnect.signTransaction({
            ...params,
            unlockPath: unlockPath.payload,
        });
        ...
        const forbiddenSignTx = await CerberusConnect.signTransaction(params);
