...
describe('analytics', () => {
    ...
    it('should report if enabled and do not report when disabled', () => {
        ...
        expect(global.fetch).toHaveBeenNthCalledWith(
            1,
            `https://data.trezorcheck.io/${app}/log/${environment}/develop.log?c_v=1.18&c_type=${actionType}&c_commit=${commitId}&c_instance_id=${instanceId}&c_session_id=${sessionId}&c_timestamp=${timestamp}&c_message_id=random`,
    ...
    it('should report even without environment option', () => {
        ...
        expect(global.fetch).toHaveBeenNthCalledWith(
            1,
            `https://data.trezorcheck.io/${app}/log/stable.log?c_v=1.18&c_type=${actionType}&c_commit=${commitId}&c_instance_id=${instanceId}&c_session_id=${sessionId}&c_timestamp=${timestamp}&c_message_id=random`,
            { method: 'GET', keepalive: true },
        );
        expect(global.fetch).toHaveBeenCalledTimes(1);
    });
