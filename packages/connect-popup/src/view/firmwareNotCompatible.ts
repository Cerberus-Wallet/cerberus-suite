// origin https://github.com/Cerberus-Wallet/connect/blob/develop/src/js/popup/view/firmwareNotCompatible.js

import { UI, createUiResponse, UiRequestUnexpectedDeviceMode } from '@cerberus/connect';
