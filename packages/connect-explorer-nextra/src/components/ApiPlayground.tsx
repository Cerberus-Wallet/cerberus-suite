...
import config from '../data/methods';
...
export const ApiPlayground = ({ method, schema }: ApiPlaygroundProps) => {
    ...
    useEffect(() => {
        if (schema) {
            ...
            const methodConfig = config.find(m => m.url === method);
            console.log('setting methodConfig', methodConfig);
            if (!methodConfig) return;
            actions.onSetMethod(methodConfig);
        }
