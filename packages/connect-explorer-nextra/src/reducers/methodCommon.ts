...
export const getParam = (field: Field<any>, $params: Record<string, any> = {}) => {
    const params = $params;
    if (field.omit) {
        return params;
    }
...
export const updateParamsNested = (schema: (Field<any> | FieldWithBundle<any>)[]) => {
...
// Set affected values
export const setAffectedValues = (state: MethodState, field: any) => {
...
export const prepareBundle = (field: any) => {
    if (field.type === 'array') {
