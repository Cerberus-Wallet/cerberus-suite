...
describe('validation', () => {
    // fixtures from https://github.com/Cerberus-Wallet/trezor-address-validator/blob/master/test/wallet_address_validator.js
    it('isAddressValid', () => {
        // BTC valid
        ...
        expect(isAddressValid('0xE37c0D48d68da5c5b14E5c1a9f1CFE802776D9FF', 'vanry')).toEqual(true);
        expect(isAddressValid('0xE37c0D48d68da5c5b14E5c1a9f1CFE802776D9FF0', 'vanry')).toEqual(
            false,
        );
