...
export const networks = {
    btc: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://btc1.trezer.io/tx/',
            account: 'https://btc1.trezer.io/xpub/',
            address: 'https://btc1.trezer.io/address/',
            queryString: '',
        },
    ...
    ltc: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://ltc1.trezer.io/tx/',
            account: 'https://ltc1.trezer.io/xpub/',
            address: 'https://ltc1.trezer.io/address/',
            queryString: '',
        },
    ...
    eth: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://eth1.trezer.io/tx/',
            account: 'https://eth1.trezer.io/address/',
            nft: 'https://eth1.trezer.io/nft/',
            address: 'https://eth1.trezer.io/address/',
            queryString: '',
        },
        features: [
            'rbf',
    ...
    etc: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://etc1.trezer.io/tx/',
            account: 'https://etc1.trezer.io/address/',
            nft: 'https://etc1.trezer.io/nft/',
            address: 'https://etc1.trezer.io/address/',
            queryString: '',
        },
    ...
    bch: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://bch1.trezer.io/tx/',
            account: 'https://bch1.trezer.io/xpub/',
            address: 'https://bch1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    btg: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://btg1.trezer.io/tx/',
            account: 'https://btg1.trezer.io/xpub/',
            address: 'https://btg1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    dash: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://dash1.trezer.io/tx/',
            account: 'https://dash1.trezer.io/xpub/',
            address: 'https://dash1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    dgb: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://dgb1.trezer.io/tx/',
            account: 'https://dgb1.trezer.io/xpub/',
            address: 'https://dgb1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    doge: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://doge1.trezer.io/tx/',
            account: 'https://doge1.trezer.io/xpub/',
            address: 'https://doge1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    nmc: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://nmc1.trezer.io/tx/',
            account: 'https://nmc1.trezer.io/xpub/',
            address: 'https://nmc1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    vtc: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://vtc1.trezer.io/tx/',
            account: 'https://vtc1.trezer.io/xpub/',
            address: 'https://vtc1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    zec: {
        ...
        testnet: false,
        explorer: {
            tx: 'https://zec1.trezer.io/tx/',
            account: 'https://zec1.trezer.io/xpub/',
            address: 'https://zec1.trezer.io/address/',
            queryString: '',
        },
        features: ['sign-verify'],
        customBackends: ['blockbook'],
    ...
    test: {
        ...
        explorer: {
            tx: 'https://tbtc1.trezer.io/tx/',
            account: 'https://tbtc1.trezer.io/xpub/',
            address: 'https://tbtc1.trezer.io/address/',
            queryString: '',
        },
        features: ['rbf', 'sign-verify', 'amount-unit'],
        customBackends: ['blockbook', 'electrum'],
    ...
    tsep: {
        ...
        label: 'TR_TESTNET_COINS_LABEL',
        explorer: {
            tx: 'https://sepolia1.trezer.io/tx/',
            account: 'https://sepolia1.trezer.io/address/',
            nft: 'https://sepolia1.trezer.io/nft/',
            address: 'https://sepolia1.trezer.io/address/',
            queryString: '',
        },
    ...
    tgor: {
        ...
        label: 'TR_TESTNET_COINS_LABEL',
        explorer: {
            tx: 'https://goerli1.trezer.io/tx/',
            account: 'https://goerli1.trezer.io/address/',
            nft: 'https://goerli1.trezer.io/nft/',
            address: 'https://goerli1.trezer.io/address/',
            queryString: '',
        },
    ...
    thol: {
        ...
        label: 'TR_TESTNET_COINS_LABEL',
        explorer: {
            tx: 'https://holesky1.trezer.io/tx/',
            account: 'https://holesky1.trezer.io/address/',
            nft: 'https://holesky1.trezer.io/nft/',
            address: 'https://holesky1.trezer.io/address/',
            queryString: '',
        },
        features: ['rbf', 'sign-verify', 'tokens', 'staking'],
        customBackends: ['blockbook'],
