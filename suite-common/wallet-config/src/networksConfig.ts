...
export const networks = {
    ...
    vanry: {
        ...
        label: 'TR_TESTNET_COINS_LABEL',
        explorer: {
            tx: 'https://vanguard.cerberus.uraanai.com/tx/',
            account: 'https://vanguard.cerberus.uraanai.com/address/',
            nft: 'https://vanguard.cerberus.uraanai.com/nft/',
            address: 'https://vanguard.cerberus.uraanai.com/address/',
            queryString: '',
        },
        features: ['rbf', 'sign-verify', 'tokens'],
        customBackends: ['blockbook'],
...
export const getNetworkFeatures = (symbol: NetworkSymbol) => {
    ...
    return networks[symbol]?.features as unknown as NetworkFeature;
}
